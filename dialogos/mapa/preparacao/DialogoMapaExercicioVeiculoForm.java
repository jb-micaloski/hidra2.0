...
/*     */ import ipqm.gsd.hidra.ihm.projetos.preparacao.janelas.controladores.ControladorExercicioVeiculoForm;
...
/*     */ 
/*     */ 
/*     */ public class DialogoMapaExercicioVeiculoForm
/*     */   extends DialogoMapa
/*     */ {
...
/*     */   
/*     */   public DialogoMapaExercicioVeiculoForm(String titulo, String descricao, Controlador controladorPai, CondicaoEntidade condicaoEntidade, TeatroOperacao exercicio, Boolean estado, List<CondicaoEntidade> lista) throws Exception {
...
/* 105 */           DialogoMapaExercicioVeiculoForm.this.coordenadaGeografica = new CoordenadaGeografica(si.getLatitude(), si.getLongitude());
/* 106 */           DialogoMapaExercicioVeiculoForm.this.velocidade = (int)si.getSpeed();
/* 107 */           DialogoMapaExercicioVeiculoForm.this.rumo = (int)si.getCourse();
/*     */         }
/*     */       };
/*     */     
...
/* 131 */       ((ControladorExercicioVeiculoForm)this.controladorPai).getTxLongitude().setText(longitude);
/* 132 */       ((ControladorExercicioVeiculoForm)this.controladorPai).getTxLatitude().setText(latitude);
/*     */       
...
/* 135 */       ((ControladorExercicioVeiculoForm)this.controladorPai).getTxMarcacao().setText(String.valueOf((int)cp.getMarcacao()));
/* 136 */       ((ControladorExercicioVeiculoForm)this.controladorPai).getTxDistancia().setText(String.valueOf((int)cp.getDistancia()));
/*     */       
/* 138 */       this.ce.setRumo(this.rumo);
/* 139 */       ((ControladorExercicioVeiculoForm)this.controladorPai).getTxRumoVeic().setText(String.valueOf(this.rumo));
/*     */       
/* 141 */       if ((this.ce.getMaquinasAssociadas() == null || this.ce.getMaquinasAssociadas().isEmpty()) && 
/* 142 */         !((ControladorExercicioVeiculoForm)this.controladorPai).getCkPrimario().isSelected()) {
/* 143 */         this.ce.setVelocidade(this.velocidade);
/* 144 */         ((ControladorExercicioVeiculoForm)this.controladorPai).getTxVelocidadeVeic().setText(String.valueOf(this.velocidade));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              /mnt/c/Users/jbmic/OneDrive/Área de Trabalho/hidra/hidra.jar!/ipqm/gsd/hidra/ihm/dialogos/mapa/preparacao/DialogoMapaExercicioVeiculoForm.class
